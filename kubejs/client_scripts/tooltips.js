ItemEvents.tooltip(e => {
    ...
    'Нанесите на детёныша животного, чтобы он не рос.'
    )

    e.add('hexerei:moon_dust_brush', 
    'Быстрый полёт может быть проблематичным для производительности сервера. Пожалуйста, летайте осторожно.'
    )
    ...
    'Декоративный блок. Рецепты используют кухонный котёл.'
    )
